...
bool PointsContainer::Awake() {
	return true;
}

bool PointsContainer::Start() {
	...
	pbody->ctype = ColliderType::POINTS_CONTAINER;
...
bool PointsContainer::Update(float dt)
{
